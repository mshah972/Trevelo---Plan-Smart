            ...
            <div
                ...
                <div className={"relative rounded-xl bg-muted"}>
                    <TextArea
                        ...
                        className={"flex field-sizing-content max-h-[200px] md:max-h-[200px] w-full rounded-xl px-4 py-3 leading-relaxed text-white placeholder:text-text-secondary focus-visible:outline-none [resize:none] shadow-none border-none focus-visible:ring-0"}
